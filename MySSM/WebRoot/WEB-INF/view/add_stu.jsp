		...
		<div class="row">
			<div class="col-md-4 col-md-offset-4 btn-group">
				...
				<button type="button" class="btn btn-default" onclick="commit();">
					<span class="glyphicon glyphicon-ok"></span>提交录入
				</button>
			</div>
		</div>
		<!-- 录入信息 -->
		<div class="row">
			<div class="col-md-3 col-md-offset-4">
				...
				<input id="name" class="form-control" type="text"
					placeholder="采集学员姓名" /> <input id="mobile" class="form-control"
					type="text" placeholder="采集学员手机" /> <select class="form-control"
					id="channel"></select> <select class="form-control" id="intent"></select>
				<h4>其他信息</h4>
				<input id="email" class="form-control" type="text"
					placeholder="email" /> <input id="qq" class="form-control"
					type="text" placeholder="QQ" /> <select class="form-control"
					id="msgsrc"></select> <input id="school" class="form-control"
					type="text" placeholder="院校" /> <input id="major"
					class="form-control" type="text" placeholder="专业" /> <select
